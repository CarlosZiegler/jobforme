  ...
  return (
    <div className="content">
      ...
      <div className="header-content">
        <img className="main-img" src={hireImg} alt="" />
        ...
        <div className="btn-header-group">
          <a href="/vagas" className="btn-primary">
            Eu estou procurando novo emprego
          </a>
          <a href="/signup" className="btn-transparent">
            Eu estou procurando profissionais
          </a>
        </div>
      </div>
      <div className="partner-container">
        ...
        <a href="/parcerias" className="btn-yellow">
          Saiba Mais
        </a>
      </div>
      <Footer />
